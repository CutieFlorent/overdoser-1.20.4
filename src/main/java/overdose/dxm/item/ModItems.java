...
//Items
    //Vanilla Item
    public static final Item WEED = Registry.register(Registries.ITEM, new Identifier(Overdoser.MOD_ID, "weed"), new Item(new FabricItemSettings()));
    //Foods
    ...
    public static final Item ClNO2 = Registry.register(Registries.ITEM, new Identifier(Overdoser.MOD_ID, "clno2"), new Item(new FabricItemSettings().food(ModFoodComponents.ClNO2)));
    public static final Item BRON = Registry.register(Registries.ITEM, new Identifier(Overdoser.MOD_ID, "bron"), new Item(new FabricItemSettings().food(ModFoodComponents.BRON)));
    //Liquid and dependencies
